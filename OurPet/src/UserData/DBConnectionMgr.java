...
public class DBConnectionMgr {
   ...
   private String _url = "jdbc:mysql://127.0.0.1:3306/ourpet";    
  
   //계정
   private String _user = "root";
   private String _password = "new1234";
...
//      
//       try {          
//           con = db.getConnection(); // 디비연결요청
//           pstmt = con.prepareStatement("select * from cpa_ad_base");
//           rs = pstmt.executeQuery(); // 쿼리실행
//           rs.next();
//           System.out.println(rs.getString("base_user"));
//          
//       } catch (Exception e) {
//           e.printStackTrace();
//       }finally{
//           db.freeConnection(con, pstmt, rs); // 연결해제
//       }
//   }
//
//}
